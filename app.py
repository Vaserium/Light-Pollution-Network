...
row0_1, row0_spacer2, row0_2, row0_spacer3 = st.columns((3, .2, 1, .1))
...
def detailed_bortle_description(bortle_scale):
    if bortle_scale == 1:
        ...
        column4.subheader("- Milky Way is visible with great detail")
        column4.subheader("- M33 (Pinwheel Galaxy) is very bright")
        column4.subheader("- Zodiacal lights visible")
        column4.subheader("- Airglow is obvious near the clouds and the horizon")
        column4.subheader("- Encompassing area is very dark")
        image = Image.open('Bortle_Class.png')
        column1.image(image, caption='Credit: OPT Telescopes', width=940)
    elif bortle_scale == 2:
        column1, column2, column3, column4 = st.columns((0.6, 2.1, 0.8, 1))
        column4.subheader("- Summer Milky Way is visible with great detail")
        column4.subheader("- M33(Pinwheel Galaxy) and other globular clusters are visible through direct vision")
        column4.subheader("- Zodiacal lights are bright, this causes feeble shadows after dark")
        column4.subheader("- Clouds appear as dark irregular balls")
        column4.subheader("- Ground is almost entirely dark")
        image = Image.open('Bortle_Class.png')
        column1.image(image, caption='Credit: OPT Telescopes', width=940)
    elif bortle_scale == 3:
        column1, column2, column3, column4 = st.columns((0.6, 2.1, 0.8, 1))
        column4.subheader("- Milky Way is visible with an outlined appearance")
        column4.subheader("- M31(Andromeda Galaxy) is visible, and other globular clusters are noticeable")
        column4.subheader("- Zodiacal lights are very bright during Spring and Autumn")
        column4.subheader("- Clouds aren't bright, and airglow is not visible")
        column4.subheader("- Ground is faintly bright")
        image = Image.open('Bortle_Class.png')
        column1.image(image, caption='Credit: OPT Telescopes', width=940)
    elif bortle_scale == 4:
        column1, column2, column3, column4 = st.columns((0.6, 2.1, 0.8, 1))
        ...
        column4.subheader("- M31(Andromeda Galaxy) is still pretty visible")
        column4.subheader("- Clouds are illuminated but they appear very faint at the zenith")
        column4.subheader("- Sky is brighter than the land")
        image = Image.open('Bortle_Class.png')
        column1.image(image, caption='Credit: OPT Telescopes', width=940)
    elif bortle_scale == 5:
        column1, column2, column3, column4 = st.columns((0.6, 2.1, 0.8, 1))
        column4.subheader("- Milky Way is extremely faint, and is completely lost alongside the horizon")
        column4.subheader(
            "- Outline of M31(Andromeda Galaxy) and the radiance of the Orion Nebula are distinguishable")
        column4.subheader("- Zodiacal lights are pretty faint during Spring and Autumn")
        column4.subheader("- Clouds are brighter than the sky")
        column4.subheader("- Ground objects seem partially lit")
        image = Image.open('Bortle_Class.png')
        column1.image(image, caption='Credit: OPT Telescopes', width=940)
    elif bortle_scale == 6 or bortle_scale == 7:
        column1, column2, column3, column4 = st.columns((0.6, 2.1, 0.8, 1))
        ...
        column4.subheader("- Only the brightest constellations remain visible")
        column4.subheader("- Clouds are incredibly lit")
        column4.subheader("- Ground objects are lit evenly")
        image = Image.open('Bortle_Class.png')
        column1.image(image, caption='Credit: OPT Telescopes', width=940)
    elif bortle_scale == 8 or bortle_scale == 9:
        column1, column2, column3, column4 = st.columns((0.6, 2.1, 0.8, 1))
        column4.subheader("- Milky Way is 100% invisible")
        column4.subheader("- Plelades Cluster is visible, and some other faint objects are visible")
        column4.subheader("- Dimmest constellations are missing key stars")
        column4.subheader("- Clouds are incredibly lit")
        column4.subheader("- The sky has a somewhat orange glow and is so bright that it can be seen at night")
        image = Image.open('Bortle_Class.png')
        column1.image(image, caption='Credit: OPT Telescopes', width=940)
